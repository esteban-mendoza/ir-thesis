...
\usepackage{lmodern}            % o libertine, newpxtext, mathpazo...
...
\includegraphics[width=3.3cm]{escudoUNAMbn.png}
...
\Large{\bf LICENCIADO EN MATEMÁTICAS APLICADAS}
...
\vspace*{0.5cm} {\Large  \bf{JORGE ESTEBAN MENDOZA ORTIZ}}
...
\vspace*{2.5cm}
\large{C.U., Ciudad de México}\hspace*{7.2cm}\large{2026}
