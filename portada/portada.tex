...
{\Large \bf{Evaluación de la fusión de rangos (\textit{rank fusion}) frente a modelos de reordenamiento neuronal (\textit{neural reranking}) en la recuperación de información en español: un análisis sobre el conjunto de datos \textsc{MessIRve}}}
