...
\begin{center}
\large{\bf Evaluación de estrategias de fusión de rangos ---\textit{rank fusion}--- en la recuperación de información en español: un análisis sobre el conjunto de datos \textsc MessIRve}
